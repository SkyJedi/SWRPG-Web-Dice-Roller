...
function shipcrit(total) {
  	var crit  = {
        ...
        option11: purpledie + purpledie + purpledie + "ngine Damaged: The ship or vehicle’s maximum speed is reduced by one point, to a minimum of one, until the Critical Hit is repaired.",
